...
base_path = '/home/ubuntu/data_and_model'
...
class GosaiDataset(torch.utils.data.Dataset):
    def __init__(self, config):
      print("[debug] Using GosaiDataset defined in:", __file__)
      base_path = config.data.root_dir
      csv_path = os.path.join(base_path, 'gosai_data/processed_data/gosai_all.csv')
...
def get_datasets_gosai(config):
  return GosaiDataset(config)
